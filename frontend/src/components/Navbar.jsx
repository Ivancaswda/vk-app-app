    ...
    return  (
        <div className='w-full flex items-center justify-between  gap-4    py-4'>
           <div className='flex items-center  gap-4'>
                ...
                <div className='pl-4'>
                    <NavLink to='/'>
                        <svg  xmlns="http://www.w3.org/2000/svg" fill='currentColor' width='240' height='25'>
               ...
               <div className='relative' onClick={() => setShowUsers(!showUsers)}>
                   ...
                   <input value={userInput} onChange={(e) => setUserInput(e.target.value)} type="text" className='bg-stone-100 pl-12 pr-4 py-1 rounded-xl'
                   ...
                   {showUsers &&
                   <div className='absolute z-40 overflow-y-auto h-[400px] md:min-w-[320px] w-[100%]  top-[33px] bg-white py-2 px-4 w-full'>
            ...
            <div>
                {authUser ? <button onClick={logout} className='px-4 py-1 border border-gray-300 rounded-lg text-sm font-semibold bg-stone-100 text-gray-800'>Выйти</button> :
                    <button onClick={() => {
                        navigate('/login')
